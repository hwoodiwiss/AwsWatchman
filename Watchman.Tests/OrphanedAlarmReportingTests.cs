    ...
    public class OrphanedAlarmReportingTests
    {
        ...
        public async Task OrphanedAlarmsAreReportedCorrectly(bool configuredAlarmsAlreadyExist)
        {
            ...
            ioc.GetMock<IAmazonCloudWatch>()
                .Setup(x => x.PutMetricAlarmAsync(Arg.Any<PutMetricAlarmRequest>(), Arg.Any<CancellationToken>()))
            ...
            ioc.GetMock<IAmazonCloudWatch>()
                .Setup(x => x.DescribeAlarmsAsync(Arg.Any<DescribeAlarmsRequest>(), Arg.Any<CancellationToken>()))
            ...
            ioc.GetMock<IAmazonSimpleNotificationService>()
                .Setup(x => x.CreateTopicAsync(Arg.Any<string>(), Arg.Any<CancellationToken>()))
